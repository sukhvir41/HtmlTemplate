...
public class SimpleTestTest {
    ...
    private final String expectedOutput = "" +
            ...
            "\n" +
            "<!--\n" +
            "    this is a comment <h1 ht-if = \"true\"> this h1 will not be processed </h1>\n" +
            "    <h1\n" +
            "    > this should also not be processed </h1>\n" +
            "-->\n" +
            "<!-- this is a comment <h1 ht-if = \"true\"> this h1 will\n" +
            "    not be processed </h1>\n" +
            "    <h1\n" +
            "    > this should also not be processed </h1>\n" +
            "-->\n" +
            ...
            "       });\n" +
            "\n" +
            "       $(\"h1\").append(\"<h1 ht-if = \"something\"> something </h1>\");\n" +
            "\n" +
            "</script>\n" +
            "\n" +
            ...
            "\n" +
            "<!-- single line script -->\n" +
            "<script>  $(\"h1\").append(\"<h1 ht-if = \"somethingSecond\"> somethingSecond </h1>\"); </script>\n" +
            "\n" +
