...
public class ElseIfConditionTestTest {
    ...
    public void testTrue() throws URISyntaxException {
        ...
        Assert.assertEquals("Else If condition test if = true", output, TestUtils.strip(getExpectedOutputTrue()));
    ...
    public void testFalse() throws URISyntaxException {
        ...
        Assert.assertEquals("ELse If condition test else if false", output, TestUtils.strip(getExpectedOutputFalse()));
