...
public class RegularHtmlTag implements HtmlTag {
    ...
    private static final Logger LOGGER = Logger.getLogger(RegularHtmlTag.class.getName());
    ...
    public void processOpeningTag(TemplateClassGenerator classGenerator) {
        LOGGER.fine("Processing opening of regular html tag. section " + htmlString);
        LOGGER.finer("Appending plain html " + htmlString + "for template " + template.getFullyQualifiedName());
